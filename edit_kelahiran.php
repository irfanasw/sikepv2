...
$qrykoreksi=mysql_query("select * from tb_kelahiran where no_surat_kelahiran='$no_surat_kelahiran' LIMIT 1");
            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Edit</small> Data Kelahiran
                        </h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <center>Form Edit Data Kelahiran</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="tes" method="post" action="update_kelahiran.php" onsubmit="return confirm('Yakin Update?')">
                                    <div class="form-group">
                                     <label>No Surat</label> 
                                     <input class="form-control" type="text" name="no_surat_kelahiran" id="no_surat_kelahiran" value="<?php echo $dataku->no_surat_kelahiran?>" style="background: #bab7a8;" size="20" maxlength="20" readonly=""/>
                                   <input type="hidden" name="no_reg_pend" id="no_reg_pend" value="<?php echo $dataku->no_reg_pend?>" /></div>
                                    <div class="form-group">
                                     <label>Nama</label> 
