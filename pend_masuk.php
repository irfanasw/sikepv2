            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Data</small> Penduduk Masuk
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-arrow-circle-o-right"></i> Penduduk Masuk
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <center>Semua Data Penduduk Masuk</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                
                                 <form name="FLaporan" method="post" action="input_masuk.php">
                                    <center><input name="fok" type="submit" id="fok" value="Input Data" class="btn btn-outline btn-danger" style="margin-bottom: 10px;">
                                    </center>
                                </form>  
                                <form name="FLaporan" method="post" action="hapus_banyak_pend_masuk.php" onsubmit="return confirm('Hapus data terpilih?')" >
                                    ...
                                    <th align="center">No SKP<br /></th>
                                    <th align="center">Klasifikasi<br /> Pindah</th>
                                    <th align="center">No KK<br /></th>
                                    <th align="center">Nama KK<br /></th>
                                    <th align="center">RT/RW<br /></th>
                                    <th align="center">Tanggal Input<br /></th>
                                    <th></th>   
                                    </tr>
                                    </thead>
                                    <?
                                    $myquery="select no_surat_masuk,nama_kk,no_kk,no_rt,no_rw,klsfksi_pindah,DATE_FORMAT(tanggal_input, '%d-%m-%Y') as tanggal_input from tb_pend_masuk ";
                                    $no=1;
                                    ...
                                    <tr>
                                    <td align="center">
                                    <input type="checkbox" name="item[]" id="item[]" value="<?php echo $dataku->no_surat_masuk?>" title="Tandai" />
                                    </td>
                                    <td width="30px" align="center"><?php echo $no;?></td>
                                    <td width="100px" align="center"><?php echo $dataku->no_surat_masuk?></td>
                                    ...
                                    <td width="120px" align="center">
                                    <a href="lihat_detmas.php?no_surat_masuk=<?php echo $dataku->no_surat_masuk?>" title="Lihat Detail Masuk" style="color: #1484CE;">Lihat</a> |        
                                     <a href="edit_pend_masuk.php?no_surat_masuk=<?php echo $dataku->no_surat_masuk?>" title="Edit" style="color: #1484CE;" ><i class="fa fa-pencil"></i></a> |
                                    <a href="hapus_pend_masuk.php?no_surat_masuk=<?php echo $dataku->no_surat_masuk?>" title="Hapus" style="color: #1484CE;" onclick="return confirm('Hapus data terpilih?')"><i class="fa fa-trash-o"></i></a>
