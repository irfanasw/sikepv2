            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Input</small> Data Pengajuan KTP
                        </h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <center>Form Input Data KTP</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="tes" method="post" action="simpan_ktp.php" onsubmit="return confirm('Apakah Yakin Untuk Menyimpan?')">
                                    <div class="form-group">
                                     <label>Nama</label> 
                                     <input class="form-control" readonly="" name="nama" id="nama" size="60" maxlength="30" placeholder="Ketikkan Nama"/>
                                    </div>
                                    <div class="form-group">
                                     <label>NIK</label> 
                                     <input class="form-control" type="text" name="nik" id="nik" size="50" maxlength="16" />
                                    </div>
                                    <div class="form-group">
                                     <label>No KK</label> 
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="jenis_kelamin" id="jenis_kelamin" size="10" maxlength="10" readonly=""/>
                                    </div>
                                    <div class="form-group">
                                     <label>Tempat</label> 
                                     <input class="form-control" type="text" name="tempat" id="tempat" size="30" maxlength="15" readonly=""/>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                     <label>Agama</label> 
                                     <input class="form-control" type="text" name="agama" id="agama" size="15" maxlength="10" readonly=""/>
                                    </div>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="pendidikan" id="pendidikan" size="50" maxlength="50" readonly=""/>
                                    </div>
                                    <div class="form-group">
                                     <label>Status Perkawinan </label> 
                                    <input class="form-control" type="text" name="status_nikah" id="status_nikah" size="15" maxlength="15" readonly=""/>
                                    </div>
                                    <div class="form-group">
                                     <label>Status Keluarga </label> 
                                     <input class="form-control" type="text" name="status_hub" id="status_hub" size="20" maxlength="20" readonly=""/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="tanggal_berlaku" id="tanggal_berlaku" size="10" placeholder="TTTT-BB-HH"/>
                                    </div> 
