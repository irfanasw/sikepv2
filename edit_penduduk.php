...
$qrykoreksi=mysql_query("select * from tb_penduduk where no_reg_pend='$no_reg_pend' LIMIT 1");
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="tes" method="post" action="update_penduduk.php" onsubmit="return confirm('Yakin Update?')">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control" type="text" name="nama_ayah" id="nama_ayah" size="50" maxlength="30" value="<?php echo $dataku->nama_ayah ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Nama Ibu </label> 
                                     <input class="form-control" type="text" name="nama_ibu" id="nama_ibu" size="50" maxlength="30" value="<?php echo $dataku->nama_ibu ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>No KK</label> 
