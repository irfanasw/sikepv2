            ...
            <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-envelope-o fa-fw"></i> Surat-surat
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center>Pilih Form Surat</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                               <form name="FLaporan" method="post" action="" >
                                    ...
                                    <tbody >
                                    <tr>
                                        <td class="zoom"><a  style="color: #1484CE;" href="domisili.php" title="Form KK"><i class="fa fa-file fa-fw"></i> Surat Keterangan Domisili</a></td>
                                         <td class="zoom"><a  style="color: #1484CE;" href="domisili.php" title="Form KK"><i class="fa fa-file fa-fw"></i> Surat Keterangan/Pengantar</a></td>
                                         <td class="zoom"><a  style="color: #1484CE;" href="skck.php" title="Form KK"><i class="fa fa-file fa-fw"></i> Surat Pengantar SKCK</a></td>
                                        
                                    </tr>
                                    <tr>
                                        <td class="zoom"><a style="color: #1484CE;" href="edit_rt.php" title="Form KK"><i class="fa fa-group fa-fw"></i> Form Kartu Keluarga</a></td>
                                        <td class="zoom"><a style="color: #1484CE;" href="edit_rt.php" title="Form KK"><i class="fa fa-group fa-fw"></i> Form Kartu Keluarga</a></td>
                                        <td class="zoom"><a style="color: #1484CE;" href="edit_rt.php" title="Form KK"><i class="fa fa-group fa-fw"></i> Form Kartu Keluarga</a></td>
                                    </tr>
                                    </tbody>
