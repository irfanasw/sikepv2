    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right" style="margin-top: 20px;margin-right: 30px;">
                <i class="fa fa-user fa-fw"></i> Hai, <b style="color: yellow;"><?php echo $_SESSION['my_name'];?></b> |
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <center><li ><b style="color: yellow;"><i class="fa  fa-calendar fa-fw"></i><?php  echo $cetak_date ?></b></li></center>
                        </li>
                        <li >
                            <a class="active" style="color: brown" href="menu.php"><i class="fa fa-home fa-fw"></i>     HOME</a>
                        </li>
                        <li  >
        ...
        <div id="page-wrapper">
            <div class="row">
                    <div class="col-lg-20">
						...
						<tr>
			<h3>  
			Tujuan Pembangunan Kelurahan Citangtu telah ditetapkan dan dituangkan dalam pernyataan Visi dan Misi yaitu mengacu pada arah dan kebijakan pemerintah kabupaten kuningan dengan membangun visi dan Misi sebagai berikut :
                     ...
                     <h2 class="breadcrumb">
						...
						<tr>
                        <h3>Mewujudkan masyarakat Kelurahan Citangtu yang "BERIMAN" (Bersih, Indah dan Nyaman)
                        </h3>
						</tr>
             <div class="col-lg-15">
                    <h2 class="breadcrumb">
						...
						<tr>
						<h3>1. Melaksanakan sebagian kewenangan kecamatan yang diserahkan kepada kelurahan
						</h3>
                        </tr>
						<tr>
						<h3>2. Memberikan pelayanan yang cepat,tepat dan adil tanpa mengabaikan prosedur kepada seluruh masyarakat kelurahan citangtu
						</h3>
                        </tr>
						<tr>
						<h3>3. Mendorong dan menggerakan partisipasi masyarakat untuk meningkatkan kesejahteraan masyarakat kelurahan citangtu
						</h3>
                        </tr>
                  <tr>
						<h3>4. Mengoptimalisasi sumber daya yang bernilai bagi penyelenggara pemerintahan, pembangunan dan pelayanan kemasyarakatan di kelurahan citangtu
						</h3>
                        </tr>
