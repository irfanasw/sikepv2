                ...
                <div class="col-lg-12">
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <center>Form Input Penduduk Masuk</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="tes" method="post" action="simpan_pend_masuk.php" onsubmit="return confirm('Apakah Yakin Untuk Menyimpan?')">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control" type="text" name="nama_ayah" id="nama_ayah" size="50" maxlength="25"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Nama Ibu </label> 
                                     <input class="form-control" type="text" name="nama_ibu" id="nama_ibu" size="50" maxlength="25"/>
                                    </div>
                                    <div class="form-group">
                                     <label>No KK</label> 
