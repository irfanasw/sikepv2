...
$qrykoreksi=mysql_query("select * from tb_sementaramasuk where no_reg_pend='$no_reg_pend' LIMIT 1");
$dataku=mysql_fetch_object($qrykoreksi);
list($tahun_lhr,$bulan_lhr,$tanggal_lhr) = explode('-',$dataku->tanggal_lahir);
            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Edit</small> Data Penduduk
                        </h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <center>Form Edit Penduduk</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="tes" method="post" action="update_sementaramasuk.php">
                                    <div class="form-group">
                                     <label>No. Reg</label> 
                                    <input class="form-control" type="text" name="no_reg_pend" id="no_reg_pend" value="<?php echo $dataku->no_reg_pend ?>" style="background: #bab7a8;" size="10" maxlength="10"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Nama</label> 
                                     <input class="form-control" type="text" name="nama" id="nama" size="50" maxlength="30" value="<?php echo $dataku->nama ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>NIK</label> 
                                     <input class="form-control" type="text" name="nik" id="nik" size="30" maxlength="16" value="<?php echo $dataku->nik ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Jenis Kelamin</label> 
                                     <div class="radio">
                                        <label>
                                           <input name="jenis_kelamin" type="radio" value="Laki-laki" <?php if($dataku->jenis_kelamin=='Laki-laki') echo "checked";?>>Laki-laki
                                        </label>
                                        <label class="radio-inline"></label>
                                        <label class="radio-inline">
                                           <input name="jenis_kelamin" type="radio" value="Perempuan" <?php if($dataku->jenis_kelamin=='Perempuan') echo "checked";?>>Perempuan
                                        </label>
                                     </div>
                                    </div>
                                    <div class="form-group">
                                     <label>Tempat</label> 
                                     <input class="form-control" type="text" name="tempat" id="tempat" size="30" maxlength="15" value="<?php echo $dataku->tempat ?>"/>
                                    </div>
                                    <div class="form-group">
                                     ...
                                     <div>
                                        ...
                                        <?php
                                            echo "<option value=".$tahun_lhr.">".$tahun_lhr."</option>";
                                            for ($i=1900;$i<=3000;$i++)
                                            {
                                            if($tahun_lhr==$i) {
                                            echo "<option value=".$i." selected>".$i."</option>";
                                    ...
                                    <div class="form-group">
                                     <label>No Akta </label> 
                                     <input class="form-control" type="text" name="no_akta" id="no_akta" size="30" maxlength="25" value="<?php echo $dataku->no_akta ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Agama</label> 
                                     <select class="form-control" name="agama" id="agama">
                                    <option ><?php echo $dataku->agama ?></option>
                                        <?php
                                        include "koneksi.php";
                                    ...
                                    <option><?php echo $dataku->status_nikah ?></option>
                                        <?php
                                        include "koneksi.php";
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="no_akta_nikah" id="no_akta_nikah" size="30" maxlength="25" value="<?php echo $dataku->no_akta_nikah ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Tanggal Nikah </label> 
                                     <input class="form-control" type="text" name="tanggal_nikah" id="tanggal_nikah" size="10" maxlength="10" placeholder="HH-BB-TTTT" value="<?php echo $dataku->tanggal_nikah?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>No Akta Cerai </label> 
                                     <input class="form-control" type="text" name="no_akta_cerai" id="no_akta_cerai" size="30" maxlength="25" value="<?php echo $dataku->no_akta_cerai ?>"/>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="tanggal_cerai" id="tanggal_cerai" size="10" maxlength="10" placeholder="HH-BB-TTTT" value="<?php echo $dataku->tanggal_cerai?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Status Hubungan </label> 
                                     <select class="form-control" name="status_hub" id="status_hub">
                                    <option ><?php echo $dataku->status_hub ?></option>
                                        <?php
                                        include "koneksi.php";
                                    ...
                                    <option ><?php echo $dataku->pendidikan ?></option>
                                        <?php
                                        include "koneksi.php";
                                    ...
                                    <option><?php echo $dataku->pekerjaan ?></option>
                                        <?php
                                        include "koneksi.php";
                                    ...
                                    <input class="form-control" type="text" name="nama_ayah" id="nama_ayah" size="50" maxlength="25" value="<?php echo $dataku->nama_ayah ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Nama Ibu </label> 
                                     <input class="form-control" type="text" name="nama_ibu" id="nama_ibu" size="50" maxlength="25" value="<?php echo $dataku->nama_ibu ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>No KK</label> 
                                     <input class="form-control" type="text" name="no_kk" id="no_kk" size="30" maxlength="16" value="<?php echo $dataku->no_kk ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>No Surat Lahir </label> 
                                     <input class="form-control" type="text" name="no_surat_kelahiran" id="no_surat_kelahiran" size="30" maxlength="20" value="<?php echo $dataku->no_surat_kelahiran ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>No Surat Masuk </label> 
                                     <input class="form-control" type="text" name="no_surat_masuk" id="no_surat_masuk" size="30" maxlength="30" value="<?php echo $dataku->no_surat_masuk ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>RT/RW</label> 
                                     <div>
                                    ...
                                    <input name="fok" type="submit" id="fok" value="Update" class="btn btn-primary"  onclick="return confirm('Yakin Update?')">
