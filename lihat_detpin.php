...
<head>
    ...
    <title> <?php echo $dataku->nama_kk ?></title>
            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Data Penduduk Pindah, <small>dari Kepala Keluarga <b><?php echo $dataku->nama_kk?></b></small>
                        </h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <center>Data Penduduk Pindah</center>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="col-lg-12">
                              <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <tr>
                                        <td>No Surat Pindah</td><td>:</td>
                                        <td><?php echo $dataku->no_surat_pindah ?></td>
                                        
                                        <td> Alamat Tujuan </td><td>:</td>
                                        <td ><?php echo $dataku->alamat_tujuan ?></td>
                                        ...
                                        <td> RT/RW Tujuan </td><td>:</td>
                                        <td><?php echo $dataku->rt_tujuan ?> / <?php echo $dataku->rw_tujuan ?></td>
                                        </tr>
                                        <tr>
                                        <td> No KK </td><td>:</td>
                                        <td><?php echo $dataku->no_kk ?></td>
                                        <td> Kec. Tujuan </td><td>:</td>
                                        <td ><?php echo $dataku->kec_tujuan ?></td>
                                        </tr>
                                        <tr>
                                        <td> RT/RW </td><td>:</td>
                                        ...
                                        <td> Prov Tujuan </td><td>:</td>
                                        <td ><?php echo $dataku->prov_tujuan ?></td></tr>
                                        <tr>
                                        ...
                                        <td> Status Nomor KK<br />Bagi Yang Tidak Pindah </td><td>:</td>
                                        <td>
                                        <?php
                                        if($dataku->status_kk_tdkpindah=='1'){
                                            ...
                                            echo "Tidak Ada Angg. Keluarga Yang Ditinggal";
                                        ...
                                        <tr>
                                        <td><b>Keluarga Yang Pindah</b></td><td>:</td><td></td>
                                        <td> Tanggal Pindah </td><td>:</td>
                                        <td><?php echo $dataku->tanggal_pindah ?></td>
                                        </tr>
                                        </table>
                                    </div>
                               </div> 
                                    ...
                                    <div class="panel-heading">
                                        <table align="center" class="table table-striped table-bordered table-hover ">
                                            ...
                                            <th align="center">Tanggal Lahir</th>
                                                ...
                                                <?
                                                $no_surat_pindah=$_GET['no_surat_pindah'];
                                                $myquery="select * from tb_detail_pend_pindah where no_surat_pindah='$no_surat_pindah' order by status_hub desc";
                                                $no=1;
