...
$no_rw=$_GET['no_rw'];
$qrykoreksi=mysql_query("select * from tb_rw where no_rw='$no_rw' LIMIT 1");
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center>Form Edit RW</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form name="FLaporan" method="post" action="update_rw.php" >
                                    <table class="table">
                                    <tr>
                                    ...
                                    <tr>
                                    <td> Nama</td><td>:</td><td><input class="form-control" type="text" name="nama_rw" id="nama_rw" size="25"  value="<?php echo $dataku->nama_rw ?>" /></td>
                                    </tr>
                                    <tr>
