...
include "tanggal.php";
include "koneksi.php";
$query = "SELECT max(no_surat_pindah) as maxKODE FROM tb_pend_pindah";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <center>Form Input Data Pindah</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="col-lg-12">
                              <div class="panel panel-red">
                                    <div class="panel-heading">
                                        <form name="tes" method="post" action="simpan_sementarapindah.php" >
                                        <div class="form-group">
                                            <label>Anggota Keluarga Yang Pindah</label>
                                            <div>
                                            <label> 
                                            <input class="form-control" type="text" name="nama" id="nama" size="50" maxlength="30" placeholder="Ketikkan nama" readonly=""/>
                                            </label>
                                            <label> 
                                            <input class="form-control" type="text" name="nik" id="nik" size="22" maxlength="16" placeholder="NIK" />
                                            </label>
                                            <label> 
                                            <input class="form-control" type="text" name="no_kk" id="no_kk" size="22" maxlength="16" placeholder="No KK" readonly=""/>
                                            </label>
                                            <label>
                                            ...
                                            <label>
                                            <input class="form-control" type="text" name="status_hub" id="status_hub" size="30" maxlength="20" placeholder="Hubungan Keluarga" readonly=""/>
                                            </label>
                                            <label>
                                            <input class="form-control" type="text" name="pendidikan" id="pendidikan" size="50" maxlength="50" placeholder="Pendidikan" readonly=""/>
                                            </label>
                                            <label>
                                            <input class="form-control" type="text" name="pekerjaan" id="pekerjaan" size="50" maxlength="50" placeholder="Pekerjaan" readonly=""/>
                                            </label>
                                             </div>  
                                        </div>
                                    ...
                                    <div class="panel-heading">
                                        <table align="center" class="table table-striped table-bordered table-hover ">
                                            ...
                                            <th align="center">Tanggal Lahir</th>
                                                ...
                                                <?
                                                $myquery="select * from   tb_sementarapindah order by status_hub desc";
                                                $no=1;
                                        ...
                                        <table align="center" class="table table-striped table-bordered table-hover" >
                                            ...
                                            <td width="10px" align="center"><a href="hapus_sementarapindah.php?no_reg_pend=<?php echo $dataku->no_reg_pend?>" title="Hapus" style="color: #1484CE;" onclick="return confirm('Hapus data terpilih?')"><i class="fa fa-trash-o"></i></a></td>
                                            </tr>
                                                <?php
                                                $no++;
                                                }
                            ...
                            <div class="col-lg-12">
                              <div class="panel panel-warning">
                                    ...
                                    <div class="row">
                                    <div class="col-lg-6">
                                        <form name="tes" method="post" action="simpan_pindah.php" onsubmit="return confirm('Apakah Yakin Untuk Menyimpan?')" >
                                         <div class="form-group">
                                            <label>No Surat Pindah</label> 
                                            <input class="form-control" type="text" name="no_surat_pindah" id="no_surat_pindah"  size="30" maxlength="30" value="<?php echo $newNo;?>" readonly="" style="background: #999;"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal Pindah</label> 
                                            <input class="form-control" type="text" name="tanggal_pindah" id="tanggal_pindah" size="10" placeholder="TTTT-BB-HH"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Nama KK</label> 
                                        ...
                                        <div class="form-group">
                                            <label>No KK</label> 
                                            <input class="form-control" type="text" name="no_kkk" id="no_kkk" size="25" maxlength="25" />
                                        </div>
                                        <div  class="form-group">
                                            <label>RT/RW </label> 
                                                <div>
                                    ...
                                    <div class="col-lg-6">
                                        <form name="tes" method="post" action="simpan_pindah.php" >
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="alamat_tujuan" id="alamat_tujuan" size="20" maxlength="20"/>
                                        </div>
                                        <div  class="form-group">
                                            <label>RT/RW Tujuan </label> 
                                                <div>
                                                <label>
                                                <input class="form-control" type="text" name="rt_tujuan" id="rt_tujuan" size="2" maxlength="2" />
                                                </label>
                                                <label>
                                                <input class="form-control" type="text" name="rw_tujuan" id="rw_tujuan" size="2" maxlength="2" />
                                                </label>
                                                </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Kecamatan Tujuan</label> 
                                            <input class="form-control" type="text" name="kec_tujuan" id="kec_tujuan" size="30" maxlength="15"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Kabupaten Tujuan</label> 
                                            <input class="form-control" type="text" name="kab_tujuan" id="kab_tujuan" size="30" maxlength="15"/>
                                        </div>
                                        <div class="form-group">
                                            <label>provinsi Tujuan</label> 
                                            <input class="form-control" type="text" name="prov_tujuan" id="prov_tujuan" size="30" maxlength="15"/>
                                        </div>
                                        <div class="form-group">
