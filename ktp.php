            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Data</small> Pengajuan KTP
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-credit-card"></i> Data KTP
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <center>Semua Data Pengajuan KTP</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                
                                 <form name="FLaporan" method="post" action="input_ktp.php">
                                    <center><input name="fok" type="submit" id="fok" value="Input Data" class="btn btn-info" style="margin-bottom: 10px;" title="Input Data KTP">
                                    </center>
                                </form>  
                                <form name="FLaporan" method="post" action="hapus_banyak_ktp.php" onsubmit="return confirm('Hapus data terpilih?')" >
                                    
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example" >
                                    <thead>
                                    <tr style="background: #31b0d5;color: #fff;"> 
                                    <th align="center">&nbsp;</th>
                                   ...
                                   <th align="center">Tanggal Input/<br />Tanggal Berlaku</th>
                                    </tr>
                                    </thead>
                                    <?
                                    $myquery="select * from tb_detail_ktp,tb_ktp where tb_detail_ktp.nik=tb_ktp.nik";
                                    $no=1;
                                    ...
                                    <input type="checkbox" name="item[]" id="item[]" value="<?php echo $dataku->nik?>" title="Tandai" />
                                    <a href="export/ktp_cetak.php?nik=<?php echo $dataku->nik?>"  title="Cetak" style="color: #1484CE;" ><i class="fa fa-print"></i></a><br />
                                    <a href="edit_ktp.php?nik=<?php echo $dataku->nik?>" title="Edit" style="color: #1484CE;"><i class="fa fa-pencil"></i></a>          
                                    <a href="hapus_ktp.php?nik=<?php echo $dataku->nik?>" title="Hapus" style="color: #1484CE;" onclick="return confirm('Hapus data terpilih?')"><i class="fa fa-trash-o"></i></a>
                                    
                                    </td>
                                    <td width="15px" align="center"><?php echo $no;?></td>
                                    <td width="100px" align="center"><?php echo $dataku->nik?><br /><?php echo $dataku->nama?></td>
                                    <td width="20px" align="center"><?php echo $dataku->jenis_kelamin?></td>
                                    <td width="80px" align="center"><?php echo $dataku->tempat?>, <?php echo $dataku->tanggal_lahir?></td>
                                    <td width="50px" align="center"><?php echo $dataku->no_rt?>/<?php echo $dataku->no_rw?></td>
                                    <td width="100px" align="center"><?php echo $dataku->pekerjaan?></td>
                                    <td width="100px" align="center" ><?php echo $dataku->tanggal_input?><br /><?php echo $dataku->tanggal_berlaku?></td>
                                     </tr>
