                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-7">
                              <div class="panel panel-default">
                                    <div class="panel-heading">
                                     ...
                                     ?> 
                                     <div align="center"><label>Tentukan Periode Register Surat Domisili</label></div>
                            ...
                            <div class="col-lg-5">
                              <div class="panel panel-default">
                                    ...
                                    <div align="center"><label></label></div>
                                        ...
                                        <a href='export/lap_domisili_excel.php?firstdate=<?php echo $_GET['tanggal_awal']?>&lastdate=<?php echo $_GET['tanggal_akhir']?>&nb=<?php echo $_POST['nasabah']?>'
                                    	target='_blank'
                                        ...
                                        <label>
                                        <form action="laporan?id=<?php echo $_GET['tanggal_awal']?>">
                                        <a href='export/lap_domisili_pdf.php?firstdate=<?php echo $_GET['tanggal_awal']?>&lastdate=<?php echo $_GET['tanggal_akhir']?>&nb=<?php echo $_POST['nasabah']?>'
                                    	target='_blank'
                                        ...
                                        <label>
                                        <form action="laporan?id=<?php echo $_GET['tanggal_awal']?>">
                                        <a href='export/lap_domisili_cetak.php?firstdate=<?php echo $_GET['tanggal_awal']?>&lastdate=<?php echo $_GET['tanggal_akhir']?>&nb=<?php echo $_POST['nasabah']?>'
                                    	target='_blank'
                            ...
                            <div class="col-lg-12">
                              <div class="panel panel-warning">
                                    <div class="panel-heading">
                                            <b>Tabel Informasi : </b> Pencarian data register Surat Domisili dari tanggal <b><?php echo $_GET['tanggal_awal']?></b> sampai dengan tanggal <b><?php echo $_GET['tanggal_akhir']?></b>
                                            <center>
                                             ...
                                             include "koneksi.php";
                                            	...
                                            	if(isset($txtcari)){
                                        		  if(empty($tanggal_awal) and empty($tanggal_akhir)){
                                                    ...
                                                    no_rt,no_rw from tb_surat_domisili ");
                                            		}else{
                                            		$sql = mysql_query("SELECT DATE_FORMAT(tanggal_input, '%d-%m-%Y') as tanggal_input,
                                                    no_surat, nama, jenis_kelamin,tempat, DATE_FORMAT(tanggal_lahir, '%d-%m-%Y') as tanggal_lahir,
