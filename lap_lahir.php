                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-7">
                              <div class="panel panel-default">
                                    <div class="panel-heading">
                                     ...
                                     ?> 
                                     <div align="center"><label>Tentukan Periode Transaksi Kelahiran</label></div>
                                     <form action="" method="get">
                          			...
                          			<label><button type="submit" name="search" class="btn btn-oitline btn-success">Search</button></label>
                            ...
                            <div class="col-lg-5">
                              <div class="panel panel-default">
                                    ...
                                    <div align="center"><label></label></div>
                                        ...
                                        <a href='export/lap_lahir_excel.php?firstdate=<?php echo $_GET['tanggal_awal']?>&lastdate=<?php echo $_GET['tanggal_akhir']?>&nb=<?php echo $_POST['nasabah']?>'
                                    	target='_blank'
                                        ...
                                        <label>
                                        <form action="laporan?id=<?php echo $_GET['tanggal_awal']?>">
                                        <a href='export/lap_lahir_pdf.php?firstdate=<?php echo $_GET['tanggal_awal']?>&lastdate=<?php echo $_GET['tanggal_akhir']?>&nb=<?php echo $_POST['nasabah']?>'
                                    	target='_blank'
                                        ...
                                        <label>
                                        <form action="laporan?id=<?php echo $_GET['tanggal_awal']?>">
                                        <a href='export/lap_lahir_cetak.php?firstdate=<?php echo $_GET['tanggal_awal']?>&lastdate=<?php echo $_GET['tanggal_akhir']?>&nb=<?php echo $_POST['nasabah']?>'
                                    	target='_blank'
                            ...
                            <div class="col-lg-12">
                              <div class="panel panel-warning">
                                    <div class="panel-heading">
                                            <b>Tabel Informasi : </b> Pencarian data transaksi kelahiran dari tanggal <b><?php echo $_GET['tanggal_awal']?></b> sampai dengan tanggal <b><?php echo $_GET['tanggal_akhir']?></b>
                                            <center>
                                    ...
                                    <div class="panel-heading scroll">
                                        <table align="center" class="table table-striped table-bordered table-hover " >
                                            ...
                                            <th align="center">No Surat lahir</th>
                                            <th align="center">Nama</th>
                                            <th align="center">Jenis kelamin</th> 
                                            <th align="center">RT/RW</th> 
                                            <th align="center">Nama Ortu</th>
                                            </tr>
                                            </thead>
                                             ...
                                             include "koneksi.php";
                                            	...
                                            	if(isset($txtcari)){
                                        		  if(empty($tanggal_awal) and empty($tanggal_akhir)){
                                            		$sql = mysql_query("SELECT * from tb_kelahiran ");
                                            		}else{
                                            		$sql = mysql_query("SELECT * from tb_kelahiran where
