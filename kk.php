            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Data</small> Kartu Keluarga
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-group fa-fw"></i> Data KK
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <center>Semua Data KK</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form name="FLaporan" method="post" action="input_kk.php">
                                    <center><input name="fok" type="submit" id="fok" value="Input Data" class="btn btn-success" style="margin-bottom: 10px;" title="Input Data KK">
                                    </center>
                                </form>  
                                 
                                <form name="FLaporan" method="post" action="hapus_banyak_kk.php" onsubmit="return confirm('Hapus data terpilih?')" >
                                    ...
                                    <th align="center">Jml. Anggota</th>
                                    <th align="center">Tanggal Input</th>
                                    <th></th>   
                                    </tr>
                                    </thead>
                                    <?
                                    $myquery="select no_reg_kk, nama_kk,no_rt,no_rw,jml_anggota,DATE_FORMAT(tanggal_input, '%d-%m-%Y') as tanggal_input from tb_kk ";
                                    $no=1;
                                    ...
                                    <input type="checkbox" name="item[]" id="item[]" value="<?php echo $dataku->no_reg_kk?>" title="Tandai" />
                                    </td>
                                    <td width="30px" align="center"><?php echo $no;?></td>
                                    <td width="300px" align="center"><?php echo $dataku->nama_kk?></td>
                                    <td width="100px" align="center"><?php echo $dataku->no_rt?> / <?php echo $dataku->no_rw?></td>
                                    <td width="120px" align="center"><?php echo $dataku->jml_anggota?> </td>
                                    <td width="120px" align="center"><?php echo $dataku->tanggal_input?></td>
                                    <td width="100px" align="center">
                                    <a href="lihat_kk.php?no_reg_kk=<?php echo $dataku->no_reg_kk?>" title="Lihat Detail KK" style="color: #1484CE;">Detail</a> |        
                                    <a href="export/kk_cetak.php?no_reg_kk=<?php echo $dataku->no_reg_kk?>&no_rt=<?php echo $dataku->no_rt?>&no_rw=<?php echo $dataku->no_rw?>"  title="Cetak" style="color: #1484CE;"  ><i class="fa fa-print"></i></a> |
                                    <a href="edit_kk.php?no_reg_kk=<?php echo $dataku->no_reg_kk?>" title="Edit" style="color: #1484CE;"><i class="fa fa-pencil"></i></a> |
                                    <a href="hapus_kk.php?no_reg_kk=<?php echo $dataku->no_reg_kk?>" title="Hapus" style="color: #1484CE;" onclick="return confirm('Hapus data terpilih?')"><i class="fa fa-trash-o"></i></a>
