...
$qrykoreksi1=mysql_query("select * from tb_ktp where nik='$nik' LIMIT 1");
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active"  >
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="ktp.php"><i class="fa fa-credit-card fa-fw"></i>   Data KTP</a>
                                </li>
                                <li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <center>Form Edit KTP</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                          <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="tes" method="post" action="update_ktp.php" onsubmit="return confirm('Yakin Update?')">
                                    ...
                                    <div class="form-group">
                                     <label>NIK</label> 
                                     <input class="form-control" type="text" name="nik" id="nik" size="50" maxlength="16" value="<?php echo $dataku->nik?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>No KK</label> 
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="tanggal_lahir" id="tanggal_lahir" size="10" maxlength="10" value="<?php echo $dataku->tanggal_lahir?>" placeholder="TTTT-BB-HH"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Agama</label> 
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="tanggal_input" id="tanggal_input" size="10" value="<?php echo $dataku1->tanggal_input ?>"/>
                                    </div> 
                                    <div class="form-group">
                                     <label>Tanggal Berlaku </label> 
                                     <input class="form-control" type="text" name="tanggal_berlaku" id="tanggal_berlaku" size="10" placeholder="TTTT-BB-HH" value="<?php echo $dataku1->tanggal_berlaku?>"/>
                                    </div> 
