...
$qrykoreksi=mysql_query("select * from tb_kematian where  no_surat_kematian='$no_surat_kematian' LIMIT 1");
            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Edit</small> Data Kematian
                        </h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <center>Form Edit Data Kematian</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="tes" method="post" action="update_kematian.php" onsubmit="return confirm('Yakin Update?')">
                                    <div class="form-group">
                                     <label>No. Surat</label> 
                                     <input class="form-control" readonly="" type="text" name="no_surat_kematian" id="no_surat_kematian" value="<?php echo $dataku->no_surat_kematian ?>" style="background: #bab7a8;" size="20" maxlength="20"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Nama</label> 
                                     <input class="form-control" readonly="" type="text" name="nama" id="nama" size="50" maxlength="30" value="<?php echo $dataku1->nama ?>"/>
                                        <input  type="hidden" name="no_reg_pend" id="no_reg_pend" size="10" maxlength="10" value="<?php echo $dataku1->no_reg_pend ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>NIK</label> 
                                     <input class="form-control" readonly="" type="text" name="nik" id="nik" size="30" maxlength="16" value="<?php echo $dataku1->nik ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Jenis Kelamin</label> 
                                     <input class="form-control" readonly="" type="text" name="jenis_kelamin" id="jenis_kelamin" size="10" maxlength="10" value="<?php echo $dataku1->jenis_kelamin ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Tempat, Tanggal Lahir</label> 
                                     <div>
                                     <label>
                                     <input readonly="" class="form-control" type="text" name="tempat" id="tempat" size="20" maxlength="15" value="<?php echo $dataku1->tempat ?>"/>
                                     </label>
                                     <label>
                                     <input class="form-control" readonly="" type="text" name="tanggal_lahir" id="tanggal_lahir" size="10" maxlength="10" value="<?php echo $dataku1->tanggal_lahir ?>"/>
                                     </label>
                                     </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div>
                                        ...
                                        <option selected><?php echo $dataku->hari_meninggal ?></option>
                                    ...
                                    <div class="form-group">
                                     <label>Agama</label> 
                                     <input class="form-control" readonly="" type="text" name="agama" id="agama" size="10" maxlength="10" value="<?php echo $dataku1->agama ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Status Perkawinan</label> 
                                     <input class="form-control" type="text" name="status_nikah" id="status_nikah" size="11" maxlength="11" value="<?php echo $dataku1->status_nikah ?>" readonly=""/>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" readonly="" type="text" name="pekerjaan" id="pekerjaan" size="50" maxlength="50" value="<?php echo $dataku1->pekerjaan ?>"/>
                                    </div> 
                                    <div class="form-group">
                                     <label>Tempat Meninggal</label> 
                                     <div class="radio">
                                        <label>
                                           <input name="tempat_meninggal" type="radio" value="Rumah Sakit" <?php if($dataku->tempat_meninggal=='Rumah Sakit') echo "checked";?>>Rumah Sakit
                                        </label>
                                        <label class="radio-inline"></label>
                                        <label class="radio-inline">
                                           <input name="tempat_meninggal" type="radio" value="Bukan Rumah Sakit" <?php if($dataku->tempat_meninggal=='Bukan Rumah Sakit') echo "checked";?>>Bukan Rumah Sakit
                                        </label>
                                     </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     <label>Desa </label> 
                                    <input class="form-control" type="text" name="desa" id="desa" size="30" maxlength="15" value="<?php echo $dataku->desa ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Kab/Kota</label> 
                                     <input class="form-control" type="text" name="kota" id="kota" size="15" maxlength="15" value="<?php echo $dataku->kota ?>"/>
                                    </div>
                                    <div class="form-group">
                                     <label>Sebab </label> 
                                     <input class="form-control"  type="text" name="sebab" id="sebab" size="50" maxlength="50" value="<?php echo $dataku->sebab ?>"/>
                                    </div>
                                    <div class="form-group">
                                     ...
                                     <div>
                                        ...
                                        <option selected><?php echo $dataku->oleh ?></option>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div>
                                        <label>
                                            <input class="form-control" type="text" readonly="" name="no_rt" id="no_rt" size="2" maxlength="2" value="<?php echo $dataku1->no_rt ?>"/>
                                        </label>
                                        <label>
                                            <input class="form-control" type="text" readonly="" name="no_rw" id="no_rw" size="2" maxlength="2" value="<?php echo $dataku1->no_rw?>"/>
                                        </label>
                                     </div>
                                    </div>
                                    <div class="form-group">
                                     <label>No KK</label> 
                                     <input class="form-control" type="text" name="no_kk" id="no_kk" size="30" maxlength="16" value="<?php echo $dataku1->no_kk ?>" readonly=""/>
                                    </div>
