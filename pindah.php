                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="tes" method="post" action="s_p.php">
                                    <div class="form-group">
                                     <label>No Surat</label> 
                                     <input class="form-control" type="text" name="no_surat_pindah" id="no_surat_pindah" size="20" maxlength="20" value="<?php echo $newNo;?>" readonly="" style="background: #bab7a8;"/></div>
                                    <div class="form-group">
                                     <label>Nama</label> 
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="status_nikah" id="status_nikah" size="15" maxlength="15"/>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="pendidikan" id="pendidikan" size="50" maxlength="50"/>
                                    </div>
                                    <div class="form-group">
                                            <label>Nama KK</label> 
