                ...
                <div class="col-lg-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <center>Laporan Data Penduduk Masuk</center>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div class="col-lg-7">
                              <div class="panel panel-default">
                                    <div class="panel-heading">
                                     ...
                                     ?> 
                                     <div align="center"><label>Tentukan Periode Transaksi Penduduk Masuk</label></div>
                                     <form action="" method="get">
                          			...
                          			<label><button type="submit" name="search" class="btn btn-primary">Search</button></label>
                            ...
                            <div class="col-lg-5">
                              <div class="panel panel-default">
                                    ...
                                    <div align="center"><label></label></div>
                                        ...
                                        <a href='export/lap_masuk_excel.php?firstdate=<?php echo $_GET['tanggal_awal']?>&lastdate=<?php echo $_GET['tanggal_akhir']?>&nb=<?php echo $_POST['nasabah']?>'
                                    	target='_blank'
                                        ...
                                        <label>
                                        <form action="laporan?id=<?php echo $_GET['tanggal_awal']?>">
                                        <a href='export/lap_masuk_pdf.php?firstdate=<?php echo $_GET['tanggal_awal']?>&lastdate=<?php echo $_GET['tanggal_akhir']?>&nb=<?php echo $_POST['nasabah']?>'
                                    	target='_blank'
                                        ...
                                        <label>
                                        <form action="laporan?id=<?php echo $_GET['tanggal_awal']?>">
                                        <a href='export/lap_masuk_cetak.php?firstdate=<?php echo $_GET['tanggal_awal']?>&lastdate=<?php echo $_GET['tanggal_akhir']?>&nb=<?php echo $_POST['nasabah']?>'
                                    	target='_blank'
                            ...
                            <div class="col-lg-12">
                              <div class="panel panel-warning">
                                    <div class="panel-heading">
                                            <b>Tabel Informasi : </b> Pencarian data penduduk masuk dari tanggal <b><?php echo $_GET['tanggal_awal']?></b> sampai dengan tanggal <b><?php echo $_GET['tanggal_akhir']?></b>
                                            <center>
                                             ...
                                             include "koneksi.php";
                                            	...
                                            	if(isset($txtcari)){
                                        		  if(empty($tanggal_awal) and empty($tanggal_akhir)){
                                            		$sql = mysql_query("SELECT * from tb_pend_masuk,tb_detail_pend_masuk 
                                            		where tb_detail_pend_masuk.no_surat_masuk=tb_pend_masuk.no_surat_masuk ");
                                            		}else{
                                            		$sql = mysql_query("SELECT * from tb_detail_pend_masuk where 
