            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Data KK, <small>dari Kepala Keluarga <b><?php echo $dataku->nama_kk?></b></small>
                        </h1>
                           ...
                           <div class="col-lg-12">
                              <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <tr>
                                        <td> No. Reg </td><td>:</td>
                                        <td ><?php echo $dataku->no_reg_kk ?></td>
                                        <td> RT/RW </td><td>:</td>
                                        ...
                                        <td><?php echo $dataku->jml_anggota ?></td>
                                        </tr>
                                        </table>
                                    </div>
                               </div> 
                                    ...
                                    <div class="panel-heading">
                                        <table align="center" class="table table-striped table-bordered table-hover ">
                                            ...
                                            <th align="center">Agama</th>
                                                ...
                                                <?
                                                $no_reg_kk=$_GET['no_reg_kk'];
                                                $myquery="select  nama,jenis_kelamin,tempat,DATE_FORMAT(tanggal_lahir, '%d-%m-%Y') as tanggal_lahir,no_akta, agama from tb_detail_kk where no_reg_kk='$no_reg_kk' order by status_hub desc ";
                                                $no=1;
                                        ...
                                        <table align="center" class="table table-striped table-bordered table-hover" >
                                            ...
                                            <th align="center">Status Hubungan</th>
                                                ...
                                                <?
                                                $no_reg_kk=$_GET['no_reg_kk'];
                                                $myquery="select status_nikah, tanggal_nikah, no_akta_nikah, tanggal_cerai, no_akta_cerai, status_hub from tb_detail_kk where no_reg_kk='$no_reg_kk' order by status_hub desc ";
                                                $no=1;
                                        ...
                                        <table align="center" class="table table-striped table-bordered table-hover ">
                                            ...
                                            <th align="center">Nama Ayah</th>
                                                ...
                                                <?
                                                $no_reg_kk=$_GET['no_reg_kk'];
                                                $myquery="select  pendidikan,pekerjaan, nama_ayah, nama_ibu from tb_detail_kk where no_reg_kk='$no_reg_kk' order by status_hub desc ";
                                                $no=1;
